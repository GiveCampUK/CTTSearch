...
//                                     _homeControllerGenericSuffix + ", " + _controllerAssemblyName);

//                    var typedControllerTypeToLocate = controllerTypeToLocate.MakeGenericType(itemType);
//                    var instance = _serviceLocator.Locate(typedControllerTypeToLocate);
